        ...
        lualine_z = {
            {
                ...
                color = {
                    ...
                    bg = require('lualine.utils.utils').extract_color_from_hllist('fg',
                        { 'Special', 'Boolean', 'Constant' }, '#000000')
                }
            }
        }
    },
...
-- focus buffers
map("n", "<Tab>", function() Util.skipUnwantedBuffers("next") end)
map("n", "<S-Tab>", function() Util.skipUnwantedBuffers("prev") end)

-- move buffers
map("n", "<A-Tab>", function() require("bufferline").move(1) end)
map("n", "<A-S-Tab>", function() require("bufferline").move(-1) end)
...
map("n", "<A-j>", function() Util.win_focus_bottom() end)
map("n", "<A-k>", function() Util.win_focus_top() end)
map("n", "<A-l>", function() Util.win_focus_right() end)
map("n", "<A-h>", function() Util.win_focus_left() end)

map("v", "<A-j>", function() Util.win_focus_bottom() end)
map("v", "<A-k>", function() Util.win_focus_top() end)
map("v", "<A-l>", function() Util.win_focus_right() end)
map("v", "<A-h>", function() Util.win_focus_left() end)

map("t", "<A-j>", function() Util.win_focus_bottom() end)
map("t", "<A-k>", function() Util.win_focus_top() end)
map("t", "<A-l>", function() Util.win_focus_right() end)
map("t", "<A-h>", function() Util.win_focus_left() end)

map("n", "<A-C-j>", function() Util.win_resize("bottom") end)
map("n", "<A-C-k>", function() Util.win_resize("top") end)
map("n", "<A-C-l>", function() Util.win_resize("right") end)
map("n", "<A-C-h>", function() Util.win_resize("left") end)

map("v", "<A-C-j>", function() Util.win_resize("bottom") end)
map("v", "<A-C-k>", function() Util.win_resize("top") end)
map("v", "<A-C-l>", function() Util.win_resize("right") end)
map("v", "<A-C-h>", function() Util.win_resize("left") end)

map("t", "<A-C-j>", function() Util.win_resize("bottom") end)
map("t", "<A-C-k>", function() Util.win_resize("top") end)
map("t", "<A-C-l>", function() Util.win_resize("right") end)
map("t", "<A-C-h>", function() Util.win_resize("left") end)
...
map("n", "<leader>as", "<cmd>Workspace BottomPanelToggle<CR>", { desc = "Toggle terminal" })
map("t", "<leader>as", "<cmd>Workspace BottomPanelToggle<CR>", { desc = "Toggle terminal" })
